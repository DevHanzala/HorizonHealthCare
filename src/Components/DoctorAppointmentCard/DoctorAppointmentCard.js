...
export default function DoctorAppointmentCard({ appointment }) {
  ...
  return (
    <Card key={appointment._id} className="shadow-lg">
      <CardHeader className="flex flex-row  items-center md:justify-start justify-center md:gap-4 gap-2">
        <Avatar className="h-12 w-12 md">
          <AvatarImage
      ...
      <CardContent className="space-y-2 text-center md:text-left">
      ...
      <CardFooter className="md:justify-end justify-evenly space-x-2">
