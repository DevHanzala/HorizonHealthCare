...
console.log("SESSION==> ",session)
  ...
  return (
    <div className="container mx-auto">
      <h1 className="font-bold md:text-2xl md:mt-10 mt-3  text-center">
      ...
      <div className="md:flex gap-4">
        <div className="shadow flex-grow md:p-3 rounded border">
          <h1 className="font font-bold md:text-2xl text-center md:text-left">Pending : {stats?.pending}</h1>
        </div>
        <div className="shadow flex-grow md:p-3 rounded border">
          <h1 className="font font-bold md:text-2xl text-center md:text-left">
      ...
      <div className="md:my-10 my-3 grid md:grid-cols-3 grid-cols-1 md:gap-4 gap-2">
