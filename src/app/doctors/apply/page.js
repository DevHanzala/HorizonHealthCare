import ApplyAsADoctorForm from "@/Components/ApplyForm";
import { auth } from "../../../../auth";
import Link from "next/link";
export default async function ApplyAsADoctor() {
    const session=await auth()
    return (
        <div className="mx-auto p-2 bg-white rounded-lg shadow-md mt-4">
            <h1 className="text-2xl text-gray-600 font-bold mb-4 text-center ">
                Apply as a Doctor on Our Platform
            </h1>
            <p className="mb-6 text-gray-600 text-center">
                Join our team of dedicated professionals and contribute to a healthier world. Please review the terms and conditions below.
            </p>
<ApplyAsADoctorForm session={session}/>
