    ...
    <div className="min-h-screen  py-6 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <p className="text-center text-gray-600 mb-12">
          We offer a range of healthcare services to ensure you and your family
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white shadow-md rounded-lg p-6">
            <div className="flex items-center justify-center mb-4">
              <div className="w-16 h-16 bg-gray-300 text-blue-900 flex items-center justify-center rounded-full text-2xl font-bold">
                🩺
              </div>
            </div>
            ...
            <p className="text-gray-600 text-center">
              Routine health assessments to keep your well-being in check and
          ...
          <div className="bg-white shadow-md rounded-lg p-6">
            ...
            <p className="text-gray-600 text-center">
              Comprehensive dental checkups, cleanings, and treatments for a
              healthy smile.
            </p>
          </div>
          ...
          <div className="bg-white shadow-md rounded-lg p-6">
            ...
            <p className="text-gray-600 text-center">
              Accurate and timely lab testing services to support diagnosis and
              treatment.
            </p>
          </div>
          ...
          <div className="bg-white shadow-md rounded-lg p-6">
            ...
            <p className="text-gray-600 text-center">
              Specialized care for infants, children, and adolescents to ensure
          ...
          <div className="bg-white shadow-md rounded-lg p-6">
            ...
            <p className="text-gray-600 text-center">
              24/7 emergency medical services to handle urgent health
              conditions promptly.
            </p>
          </div>
          ...
          <div className="bg-white shadow-md rounded-lg p-6">
            ...
            <p className="text-gray-600 text-center">
              Expert physiotherapy services to aid recovery and improve
              mobility.
            </p>
          </div>
        </div>
